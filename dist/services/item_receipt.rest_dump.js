...
exports.NS_REST_ITEM_RECEIPT_DUMP_COLLECTION = void 0;
...
async function persistRestItemReceiptRows(items, options) {
    const base = {
        saved: false,
        collection: exports.NS_REST_ITEM_RECEIPT_DUMP_COLLECTION,
        upserted: 0,
        skipped: 0,
        errors: 0,
    };
    ...
    const col = ns_db.collection(exports.NS_REST_ITEM_RECEIPT_DUMP_COLLECTION);
    const now = new Date();
    ...
    base.saved = true;
    logger_config_1.default.info(`[NS REST item receipt dump] collection=${exports.NS_REST_ITEM_RECEIPT_DUMP_COLLECTION} upserted=${base.upserted} skipped=${base.skipped} errors=${base.errors}`);
    return base;
}
