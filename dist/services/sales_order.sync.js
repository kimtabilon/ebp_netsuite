...
exports.retryUnmappedSalesOrders = exports.retryFailedSalesOrders = exports.syncSalesOrdersToNetsuite = void 0;
 ...
 */
async function syncOneOrder(collection, order, directNetSuiteCall = false) {
    ...
    if (result.success === true && result.action === "no_items") {
        await markResolved(collection, order, "no_items", `No valid SKUs in NS: ${result.skipped ? result.skipped.join(", ") : result.skus_attempted || "unknown"}`);
        logger_config_1.default.info(`[NS SO Sync] No valid items (create skipped): ${ref}`);
