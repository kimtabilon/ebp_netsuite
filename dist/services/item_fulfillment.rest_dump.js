...
exports.NS_REST_ITEM_FULFILLMENT_DUMP_COLLECTION = void 0;
...
async function persistRestItemFulfillmentRows(items, options) {
    const base = {
        saved: false,
        collection: exports.NS_REST_ITEM_FULFILLMENT_DUMP_COLLECTION,
        upserted: 0,
        skipped: 0,
        errors: 0,
    };
    ...
    const col = ns_db.collection(exports.NS_REST_ITEM_FULFILLMENT_DUMP_COLLECTION);
    const now = new Date();
    for (const item of items) {
        ...
        try {
            ...
            base.errors++;
            logger_config_1.default.error(`[NS REST item fulfillment dump] upsert failed for ${nsId}:`, err?.message || err);
        }
    }
    base.saved = true;
    logger_config_1.default.info(`[NS REST item fulfillment dump] collection=${exports.NS_REST_ITEM_FULFILLMENT_DUMP_COLLECTION} upserted=${base.upserted} skipped=${base.skipped} errors=${base.errors}`);
    return base;
}
